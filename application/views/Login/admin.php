					...
					<div class="modal-body">
						<div>
							...
							<form action="">
								<div class="form-floating my-3">
									<input type="text" class="form-control" name="adminUsername" id="forgotPassUsername" placeholder="Username">
						...
						<div hidden="true">
							<form action="">
								...
								<div class="form-floating my-3">
									<input type="text" class="form-control" name="adminNewPass" id="newpass" placeholder="New Password">
									<label for="newpass" class="py-2">New Password</label>
								</div>
								<div class="form-floating mb-3">
									<input type="text" class="form-control" name="adminOldPass" id="confirmpass" placeholder="Confirm Password">
