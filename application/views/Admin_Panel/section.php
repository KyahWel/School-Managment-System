        ...
        <div class="table-wrapper">
            ...
            <div class="table-responsive">  
                <table class="table align-middle table-striped table-borderless table-hover" id="table-body">
                    ...
                    <tbody>
                        <tr><input class="mx-3" type="checkbox" name="addStudent" class="mx-2">Select 25 Students</tr>   
                        <tr>
                            <td style="text-align: justify"><input type="checkbox" name="addStudent" class="mx-2">1</td>
                            <td>Stud001-2001</td>
                            <td>Lida Cruz</td>
                            <td>First Year</td>
                            <td>Course 1</td>
                        ...
                        <tr>
                            <td style="text-align: justify"><input type="checkbox" name="addStudent" class="mx-2">2</td>
                            <td>Stud001-2002</td>
                        ...
                        <tr>
                            <td style="text-align: justify"><input type="checkbox" name="addStudent" class="mx-2">3</td>
                            <td>Stud001-2003</td>
                            <td>Sarah Jimenez</td>
                            <td>First Year</td>
                            <td>Course 1</td>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-6"> <!--Capacity-->
                                        ...
                                        <select name="capacity" class="form-control">
                                            ...
                                            <option value="capacity">30</option>
                                        </select>
                                    </div>
                                </div>
                            </form>
