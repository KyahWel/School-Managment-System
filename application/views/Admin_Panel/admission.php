...
<div class="height-100 pt-2 container-fluid pb-3">
	<h3 class="pt-3 fw-bold" id="tab" style="display:block">Admission</h3>
		...
		<div class="accordion accordion-flush" id="accordion-addExamSchedule">
			<div class="accordion-item">
				<h2 class="accordion-header">
					...
					data-bs-target="#addExamSchedule" aria-expanded="false" aria-controls="addExamSchedule">
						Add Exam Schedule
					</button>
				</h2>
				<div id="addExamSchedule" class="accordion-collapse collapse" aria-labelledby="addExamScheduleHeader" 
				data-bs-parent="#accordion-addExamSchedule">
					<div class="accordion-body">
						<form method="POST" action="<?php echo site_url('ExamController/addExam') ?>" class="formExam">
							...
							<div class="row mb-3">
								<div class="col-lg-6 col-md-12">
									...
									<select class="form-select" name="building" aria-labelledby="Building">
										...
										<option value="College of Industrial Education">
											College of Industrial Education
										</option>
										<option value="College of Architecture and Fine Arts">
							...
							<div class="addExamScheduleButton d-flex justify-content-end">
								<!--Buttons-->
								<button class="btn btn-default" id="examSave" type="submit" name="submit" 
                                value="save">Save</button>
								<button class="btn btn-default" id="examCancel" type="reset" 
	...
	<div class="col-12 align-self-center my-3" id="viewApplicantEnrolledStudents" style="display:block">
		<ul class="nav nav-tabs d-flex flex-row justify-content-start" id="viewTab" role="tablist">
			<li class="nav-item" role="presentation">
				<button class="nav-link active" id="viewSchedButton" data-bs-toggle="tab" data-bs-target="#scheduleTabContent"
                type="button" role="tab" aria-controls="scheduleTabContent" aria-selected="true">Exam Schedule</button>
			</li>
			<li class="nav-item" role="presentation">
				<button class="nav-link" id="viewApplicantButton" data-bs-toggle="tab" data-bs-target="#applicantTabContent"
                type="button" role="tab" aria-controls="applicantTabContent" aria-selected="false">Applicant</button>
			</li>
			<li class="nav-item" role="presentation">
				<button class="nav-link" id="viewEnrollmenttButton" data-bs-toggle="tab" data-bs-target="#enrollmentTabContent"
                type="button" role="tab" aria-controls="enrollmentTabContent" aria-selected="false">Enrollment</button>
			</li>
		</ul>
		<div class="tab-content ">
			<!-- Information Tab -->
			<div class="tab-pane show active pt-3" id="scheduleTabContent" role="tabpanel" 
            aria-labelledby="scheduleTab Content">
										...
										<div class="action-buttons">
											<?php if ($examrow->status == 1) : ?>
												<button type="button" id="edit" 
                                                        data-id='<?php echo $examrow->schedID; ?>' 
                                                        class="btn edit_data" data-bs-toggle="modal" 
                                                        data-bs-target="#editExamSchedule">
													<i class="fas fa-pen" data-bs-toggle="tooltip" title="Edit"></i> 
                                                    Edit
                                                </button>
												<button type="button" class="btn" id="status" 
                                                        onclick="location.href='<?php if ($examrow->status == 1)
                                                        {
			...
			<!--Edit Exam Schedule-->
			<div class="modal fade" id="editExamSchedule" tabindex="-1" aria-modal="true" aria-labelledby="editExamHeader" 
            aria-hidden="true">
			...
			<div class="tab-pane" id="applicantTabContent" role="tabpanel" aria-labelledby="Applicants">
				<div class="table-responsive py-2">
                    ...
                    aria-labelledby="Applicants table">
						<!--Table Body-->
						<thead>
							<tr>
								<th class="pb-3" scope="col">Applicant ID</th>
								<th class="pb-3" scope="col">Name</th>
								<th class="pb-3" scope="col">Course</th>
									...
									<tr>
										...
										<td>
											<button type="button" onclick="applicantDetails()" 
                                                data-id='<?php echo $applicantrow->applicantID; ?>' 
					...
					<div class=" d-flex justify-content-end my-3 p-3">
						<button type="button" class="btn btn-primary btn-sm text-uppercase addALL px-3" 
                            id="addAll" data-bs-toggle="modal" data-bs-target="#addApplicant">
							ADD ALL PASSED APPLICANTS
                        </button>
					</div>

					<!-- Add All PASSED Applicants Pop up Dialog-->
					<div class="modal fade" id="addApplicant" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" 
                    aria-modal="true" aria-labelledby="cancelApplicationLabel" aria-hidden="true">
                                            ...
                                            { ?>
												<?php if ($applicantrow->applicant_result == "Passed") : ?>
													...
													<input type="text" hidden class="form-control" name="applicantID[]"
                                                        value="<?php echo $applicantrow->applicantID ?>">
													<input type="text" hidden class="form-control" name="lastname[]" 
                                                        value="<?php echo $applicantrow->lastname ?>">
												<?php endif ?>
											<?php } ?>
										</ul>
									</div>
			...
			<div class="tab-pane" id="enrollmentTabContent" role="tabpanel" aria-labelledby="Enrollment">
				<div class="px-5 pt-3 my-0 pb-0 text-center table-wrapper-2 ">
					<div class="wrap">
	...
	<div class=" pt-2 container-fluid mb-4" id='viewApplicantDetails' style="display:none">
		<div class="mx-2">
			<button type="button" class="btn btn btn-danger my-3" onclick="enrollment()" 
        ...
        <div class="viewStudentContent d-flex align-items-center">
            ...
            <div class="table-responsive">
                <table id="viewStudentInformation" class="table-body">
                    <tr>
                        <td class="px-3 pt-2">
                            <p><strong>Student ID:</b></strong>
                            <p><strong>Name:</b></strong>
                            <p><strong>Course:</b></strong>
                            <p><strong>Term/Sem:</b></strong>
                        </td>
                        <td class="pt-2 px-2">
                            <strong>TUPM-STUDENT21-1234</strong>
                            <strong>Lida Cruz</strong>
        ...
        <div class="enrollmentDetails mt-3 mb-5" id="details">
            ...
            <div class="tabDetails p-3">
                ...
                <div class=" d-flex justify-content-end my-3 mx-2">
                    <button type="button" class="btn btn-primary text-uppercase confirmEnrollment px-3" style="padding: 7px;"> 
                        Confirm
                    </button>
                </div>
            </div>
