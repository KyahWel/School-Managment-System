                    ...
                    <fieldset disabled>
                        ...
                        <div class="row mt-2 small">
                            ...
                            <div class="col-lg-3 col-md-12">
                                <input type="text" name="LRN" value="<?= $this->session->userdata('auth_user')['LRN']?>" class="form-control form-control-sm" minlength="10" aria-label="LRN" readonly>
                            </div>
                        ...
                        <div class="row mt-2 small">
                            ...
                            <div class="col-lg-3 col-md-12">
                                <input type="tel" name='contactnum' value="<?= $this->session->userdata('auth_user')['contactnum']?>" class="form-control form-control-sm" aria-label="Contact Number" readonly>
                            </div>
                            <div class="col-lg-2 col-md-none"> </div>

                            <label class="form-label col-lg-2 col-md-12 pt-1">Landline:</label>
                            <div class="col-lg-3 col-md-12">
                                <input type="tel" name='landline' value="<?= $this->session->userdata('auth_user')['landline']?>" class="form-control form-control-sm" aria-label="Landline" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mt-2 small">
                            ...
                            <div class="col-lg-4">
                                <input type="email" name='email' value="<?= $this->session->userdata('auth_user')['email']?>" class="form-control form-control-sm" aria-label="Email Address" readonly>
                            </div>
                            <hr class="mt-4 mb-3">
                        </div>
                        ...
                        <div class="row mt-2 small">
                            ...
                            <div class="col-lg-3 col-md-12">
                                <input type="text" name='unit' value="<?= $this->session->userdata('auth_user')['unit']?>" class="form-control form-control-sm" aria-label="Unit Number" readonly>
                            </div>
                            <div class="col-lg-2 col-md-none"> </div>

                            <label class="form-label col-lg-2 col-md-12 pt-1">Street:</label>
                            <div class="col-lg-3 col-md-12">
                                <input type="text" name='street' class="form-control form-control-sm" value="<?= $this->session->userdata('auth_user')['street']?>" aria-label="Street" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mt-2 small">
                            ...
                            <div class="col-lg-3 col-md-12">
                                <input type="text" name='barangay' value="<?= $this->session->userdata('auth_user')['barangay']?>" class="form-control form-control-sm" aria-label="Barangay" readonly>
                            </div>
                            <div class="col-lg-2 col-md-none"> </div>

                            <label class="form-label col-lg-2 col-md-12 pt-1">City:</label>
                            <div class="col-lg-3 col-md-12">
                                <input type="text" name='city' class="form-control form-control-sm" value="<?= $this->session->userdata('auth_user')['city']?>" aria-label="City" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mt-2 small">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <input type="text" name='zipcode' value="<?= $this->session->userdata('auth_user')['zipcode']?>" class="form-control form-control-sm" aria-label="Zipcode" readonly>
                            </div>
                            <div class="col-lg-2 col-md-none"> </div>

                            <label class="form-label col-lg-2 col-md-6 pt-1">Province:</label>
                            <div class="col-lg-3 col-md-6">
                                <input type="text" name='province' value="<?= $this->session->userdata('auth_user')['province']?>" class="form-control form-control-sm" aria-label="Province" readonly>
                            </div>
                        </div>
                    </fieldset>
                    <!--  Next Step button-->
