    ...
    <div class="container-fluid">
        <div class="row height-100vh">
                ...
                <div class="d-flex flex-md-column flex-row flex-grow-1 align-items-center text-dark">
                    <div href="/" class="d-block align-items-center pb-sm-3 text-dark text-decoration-none">
                        <div class="d-none d-md-inline">
                            <img src="../assets/images/applicantAvatar.svg"
                            alt="Applicant Avatar" class="pt-4 mx-4" style="width: 125px;">
                            <br>
            ...
            <div class="col d-flex flex-column">
                ...
                <div class="alert mt-3 alert-success alert-dismissible fade show d-flex align-items-center"
                role="alert">
                ...
                <div id='final_step' class="container mt-2 pt-4">
                    <div class="Wrapper">
                        ...
                        <div class="Contents">
                            ...
                            <p class="note2 pt-4"> Take the TUPSTAT on scheduled date, time, and specific venue.&nbsp;
                            ...
                            onclick="location.href='<?php echo site_url('applicantRegistration/downloadTestPermit/'.$student->applicantID) ?>'">
                            Download Test Permit </button>
                            ...
                            <div class="d-flex align-items-end">
                                ...
                                class="btn finishedButton btn-default text-white ms-auto my-3 mx-2 px-4" 
