					...
					<div id="carouselControls" class="carousel carousel-dark slide px-3 " data-bs-ride="carousel">
						<div class="carousel-inner">
							...
							<div class="carousel-item px-5">
								<h5 class="title text-uppercase text-dark"> <?php echo $announcement->title ?>,
									<?php echo $announcement->date ?>, <?php echo $announcement->time ?></h5>
								<div class="d-flex justify-content-between">
									...
									<div>
										<button type="button" data-id='<?php echo $announcement->eaID ?>'
											...
											data-bs-toggle="modal" data-bs-target="#viewAnnouncementDetailsFaculty">
											View Details
										</button>
									</div>
								</div>
						...
						<div class="modal fade" id="viewAnnouncementDetailsFaculty" tabindex="-1" aria-modal="true"
